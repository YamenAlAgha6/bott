...
let owners = '1076256190503321641'//اي دي حقك 
let owner;
const
  updateAdmins = () => {
  owner = db.get("admins")
  owners = '979372647530000444'//ايدي الي هيتحول عند الشراء
  owner.unshift('1076256190503321641')//اي دي حقك
}
updateAdmins()
...
client.login("حط هنا توكن بوتك");///By Bleto_YT